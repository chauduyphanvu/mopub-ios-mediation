...
s.subspec 'MoPub' do |ms|
  ms.dependency 'mopub-ios-sdk/Core', '~> 5.17'
  ms.dependency 'mopub-ios-sdk/NativeAds', '~> 5.17'
end
s.subspec 'Network' do |ns|
  ns.source_files = 'AdMob/*.{h,m}'
  ns.dependency 'Google-Mobile-Ads-SDK', '8.11.0'
  ns.dependency 'mopub-ios-sdk/Core', '~> 5.17'
  ns.dependency 'mopub-ios-sdk/NativeAds', '~> 5.17'
end
end
